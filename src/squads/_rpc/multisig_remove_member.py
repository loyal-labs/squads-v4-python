...
from ..transactions import multisig_remove_member as create_transaction
...
async def multisig_remove_member(
    ...
    """
    Add a member/key to the multisig and reallocate space if needed.

    Must be signed by `configAuthority` and `feePayer` before sending it.
    """
